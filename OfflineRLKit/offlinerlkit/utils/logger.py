...
project_dir = str(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))))
...
def make_log_dirs(
    ...
    # log_dirs = os.path.join('/home/liky/multiview/log', task_name, algo_name, exp_name)
    if encoder_name is not None:
        algo_name = f'{encoder_name}_{algo_name}'
    if dir_base is None:
        dir_base = project_dir + "/logs/rl"

    log_dirs = os.path.join(dir_base, task_name, algo_name, exp_name)
